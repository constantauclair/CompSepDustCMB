...
file_name="separation_multifreq_L12345678_"+mode+"modes.npy"
...
if mode=='E':
    ...
    CMB_1 = np.load('data/realistic_data/CMB_TEB_8arcmin_microK.npy')[1,0]
    CMB_2 = np.load('data/realistic_data/CMB_TEB_8arcmin_microK.npy')[1,0]
    
    CMB_1_syn = np.load('data/realistic_data/CMB_TEB_8arcmin_microK.npy')[1,1:Mn+1]
    CMB_2_syn = np.load('data/realistic_data/CMB_TEB_8arcmin_microK.npy')[1,1:Mn+1]
...
if mode=='B':
    ...
    CMB_1 = np.load('data/realistic_data/CMB_TEB_8arcmin_microK.npy')[2,0]
    CMB_2 = np.load('data/realistic_data/CMB_TEB_8arcmin_microK.npy')[2,0]
    
    CMB_1_syn = np.load('data/realistic_data/CMB_TEB_8arcmin_microK.npy')[2,1:Mn+1]
    CMB_2_syn = np.load('data/realistic_data/CMB_TEB_8arcmin_microK.npy')[2,1:Mn+1]
...
TCMB = np.load('data/realistic_data/CMB_TEB_8arcmin_microK.npy')[0,0]

TCMB_syn = np.load('data/realistic_data/CMB_TEB_8arcmin_microK.npy')[0,1:Mn+1]
